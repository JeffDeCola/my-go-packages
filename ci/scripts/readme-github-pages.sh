#!/bin/sh
# my-go-packages readme-github-pages.sh
...
echo "The goal is to git clone /my-go-packages to /my-go-packages-updated"
...
echo "   /my-go-packages"
echo "   /my-go-packages-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone my-go-packages to my-go-packages-updated"
git clone my-go-packages my-go-packages-updated
echo " "

echo "cd my-go-packages-updated"
cd my-go-packages-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-go-packages\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-go-packages\/master\/svgs\//g' temp-README.md
echo " "
